...
class build_ext(_build_ext):
    ...
    def build_extensions(self):
        # The include directory for the scats headers
        localincl = os.path.join("lib", "scats")
        if not os.path.exists(os.path.join(localincl, "version.h")):
            raise RuntimeError("couldn't find scats headers")
